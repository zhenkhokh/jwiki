...
public final class CAction
{
	 ...
	 */
	public static ArrayList<String> delete(Wiki wiki, final String reason, ArrayList<String> titles)
	{
	 ...
	 * @return A list of pages we didn't delete.
	 */
	public static ArrayList<String> undelete(Wiki wiki, final boolean agressive, final String reason, ArrayList<String> titles)
	{
	 ...
	 * @return A list of titles we couldn't process.
	 */
	public static ArrayList<String> edit(Wiki wiki, final boolean append, final String reason, final String add, final String replace,
			final String replacement, ArrayList<String> titles)
	{
